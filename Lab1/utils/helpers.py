...
Used by experiments to persist trained models and report sizes.
"""
...
def save_checkpoint(model: nn.Module, path: str) -> None:
    ...
    ----------
    model : nn.Module
    path  : str   — file path ending in .pth  (e.g. "checkpoints/ann_small.pth")
    """
...
def count_parameters(model: nn.Module) -> dict:
    ...
    result    = {"total": total, "trainable": trainable}
    return result
